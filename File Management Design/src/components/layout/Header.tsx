    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: "Image Enlarger", icon: ZoomIn },
...
// Tools that have dedicated pages
const TOOL_ROUTES: Record<string, string> = {
  ...
  "Sign PDF": "/sign-pdf",
  "Remove Watermark": "/remove-watermark-pdf",
  ...
  // Add more tool routes here as pages are created
};
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
                                      ...
                                      {displayItems.map((item) => {
                                        ...
                                        return (
                                          <button
                                            ...
                                            onClick={() => {
                                              const toolRoute = TOOL_ROUTES[item.name];
                                              if (toolRoute) {
                                                // Tool has a dedicated page - navigate to it
                                                navigate(toolRoute);
                                                setActiveMenu(null);
                                              } else {
            ...
            <div className="hidden lg:flex items-center gap-3">
              <button 
                onClick={() => {
                  // If on home page, scroll to all-tools section
