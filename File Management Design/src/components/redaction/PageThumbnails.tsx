/**
 * PageThumbnails Component for Redaction
 * 
 * Purpose: Vertical list of page thumbnails for redaction editor
 * Features:
 ...
 * - Show redaction count indicator on pages with redactions
      ...
      {pages.map((page) => (
        ...
        >
          <div className="relative">
            ...
            {/* Page number and redaction indicator */}
            <div className="flex items-center justify-between px-0.5">
              ...
              {page.redactionCount > 0 && (
                <div className="flex items-center gap-0.5">
                  <EyeOff className="w-3 h-3 text-purple-500" />
                  <span className="text-[9px] font-medium text-purple-600">{page.redactionCount}</span>
                </div>
              )}
            </div>
          </div>
