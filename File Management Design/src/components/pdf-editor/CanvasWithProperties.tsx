/**
 * Canvas with Properties Component
 * 
 * Combined view: Canvas on left (wider), Properties panel on right (narrower)
...
interface CanvasWithPropertiesProps {
  currentPage: number;
  totalPages: number;
  activeTool: string;
...
export function CanvasWithProperties({
  currentPage,
  totalPages,
  activeTool,
  selectedElements,
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      ...
      {/* Properties Panel - Right side (narrower) */}
      <PropertiesPanel
